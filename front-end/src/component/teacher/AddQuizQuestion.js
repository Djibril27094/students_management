...
function AddQuizQuestion() {
    ...
    const formSubmit = () => {
        ...
        axios.post(baseUrl + '/quiz-questions/' + quiz_id , _formData,{
            ...
            Swal.fire({
                question:"Question has been added",
                icon:"success",
                toast:true,
                timer:3000,
                position:'top-right',
    ...
    <div className="container mt-4">
        <div className="row">
            ...
            <div className="col-md-9">
                <div className="card">
                    <h5 className="card-header">Add Questions <Link to={`/all-questions/${quiz_id}`} className='btn btn-success float-end'>All Questions</Link></h5>
